...
class Theme1AppPages {
  ...
  static final routes = [
    ...
    GetPage(
        name: Routes.SALONS,
        page: () => SalonsView(),
        binding: SalonsBinding(),
        middlewares: [AuthMiddleware()]),
    GetPage(
        name: Routes.SALON_FORM,
        page: () => SalonFormView(),
        binding: SalonBinding(),
        middlewares: [AuthMiddleware()]),
    GetPage(
        name: Routes.SALON_ADDRESSES_FORM,
        page: () => SalonAddressesFormView(),
        binding: SalonBinding(),
        middlewares: [AuthMiddleware()]),
    GetPage(
      name: Routes.SALON_ADDRESS_PICKER,
    ...
    GetPage(
        name: Routes.SALON_AVAILABILITY_FORM,
        page: () => SalonAvailabilityFormView(),
        binding: SalonBinding(),
        middlewares: [AuthMiddleware()]),
...
//
// import 'package:get/get.dart';
// import '../views/address_picker_view.dart';
